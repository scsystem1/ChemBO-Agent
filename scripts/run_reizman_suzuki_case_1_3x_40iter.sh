...
DEFAULT_PROBLEM="${ROOT_DIR}/examples/reizman_suzuki_case_1_problem.yaml"
DEFAULT_CONFIG="${ROOT_DIR}/dashscope_kimi.yaml"
REPEATS="${REPEATS:-3}"
BUDGET="${BUDGET:-40}"
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/outputs/reizman_suzuki_case_1_3x_40iter}"
TASK_NAME_OVERRIDE="${TASK_NAME:-reizman_suzuki_case_1_3x_40iter}"
...
if not isinstance(base_problem, dict):
    raise RuntimeError("Reizman Suzuki batch script expects a structured YAML/JSON problem file.")
...
for run_index in range(1, repeats + 1):
    ...
    print("============================================================")
    print(f"Reizman Suzuki case 1 repeat {run_index}/{repeats}")
