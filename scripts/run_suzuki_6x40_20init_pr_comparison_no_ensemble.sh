...
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/outputs/suzuki_6x40_20init_pr_comparison_no_ensemble}"
TASK_NAME_OVERRIDE="${TASK_NAME:-suzuki_6x40_20init_pr_comparison_no_ensemble}"
...
def _run_mode(
    *,
    ...
    for run_index in range(1, repeats + 1):
        ...
        print(
            "Settings override: "
            f"pure_reasoning_ablation_enabled={pure_reasoning_enabled}, ensemble_af=False"
        )
        print("============================================================")
...
baseline_output_dir = output_dir / "no_pure_reasoning_no_ensemble"
pure_reasoning_output_dir = output_dir / "pure_reasoning_no_ensemble"
baseline_output_dir.mkdir(parents=True, exist_ok=True)
pure_reasoning_output_dir.mkdir(parents=True, exist_ok=True)
...
all_summaries.extend(
    _run_mode(
        ...
        mode_output_dir=baseline_output_dir,
...
all_summaries.extend(
    _run_mode(
        ...
        mode_output_dir=pure_reasoning_output_dir,
        experiment_name=f"{task_name_override}_pure_reasoning",
    )
)
