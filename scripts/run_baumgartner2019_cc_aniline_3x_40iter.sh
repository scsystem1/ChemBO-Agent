...
DEFAULT_PROBLEM="${ROOT_DIR}/examples/baumgartner2019_cc_aniline_problem.yaml"
DEFAULT_CONFIG="${ROOT_DIR}/dashscope_kimi.yaml"
REPEATS="${REPEATS:-3}"
BUDGET="${BUDGET:-40}"
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/outputs/baumgartner2019_cc_aniline_3x_40iter}"
TASK_NAME_OVERRIDE="${TASK_NAME:-baumgartner2019_cc_aniline_3x_40iter}"
...
if not isinstance(base_problem, dict):
    raise RuntimeError("Baumgartner batch script expects a structured YAML/JSON problem file.")
...
for run_index in range(1, repeats + 1):
    ...
    print("============================================================")
    print(f"Baumgartner aniline repeat {run_index}/{repeats}")
