...
def main():
    parser = argparse.ArgumentParser(description="Run GOLLuM DeepGP on DAR, OCM, Suzuki, or OER.")
    parser.add_argument("--dataset", choices=["dar", "ocm", "suzuki", "oer"], required=True)
